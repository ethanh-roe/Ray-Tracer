...
class camera {
    public:
        ...
        color background;                   // Background color for scene
    ...
    void initialize() {
        ...
        // Calculate the vectors across the horizontal and down the veritcal viewport edges
        ...
        // Calculate the location of the upperr left pixel
